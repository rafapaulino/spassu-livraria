                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="alert alert-danger alert-dismissible fade show rounded-0 my-2" role="alert">
                                    Ocorreu um problema durante a atualização: <strong>{{ $message }}</strong>
                        ...
                        <div class="col-12">
                            <div class="card rounded-0 card-crud">
                                <h2 class="card-header">
                                    <i class="fa-solid fa-book-open-reader"></i> Atualização de Assunto
                                </h2>
                                <div class="card-body p-3">
                                    <form class="form container form-validate" method="POST" action="{{ route('assunto.update', $assunto->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                ...
                                                <input type="text" class="form-control rounded-0" name="descricao" id="descricao" placeholder="Coloque o assunto aqui..." required maxlength="20" value="{{ $assunto->descricao }}">
                                            </div>
                                        </div>
                                        <div class="row">
